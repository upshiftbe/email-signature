    ...
    <Card className="border border-slate-200 bg-white/90 text-slate-900 shadow-2xl shadow-slate-900/5">
      <CardHeader className="space-y-4">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
          ...
          <Button
            type="button"
            className="h-10 cursor-pointer border border-rose-200 bg-white px-3 text-sm font-semibold text-rose-700 shadow-sm shadow-rose-200 hover:border-rose-300 hover:bg-rose-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-500/70"
            onClick={onReset}
          >
            Reset form
          </Button>
