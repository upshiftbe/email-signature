...
export const FORM_FIELDS: FormField[] = [
  ...
  },
  {
    ...
    type: 'url',
    hint: 'Optional, the Facebook icon only appears once this is set.',
  },
  {
    id: 'input-linkedin',
    label: 'LinkedIn URL',
    placeholder: 'https://www.linkedin.com/company/upshift-be',
    type: 'url',
    hint: 'Optional, the LinkedIn icon only appears once this is set.',
  },
  {
    id: 'input-instagram',
    label: 'Instagram URL',
